...
const navigation: NavigationItem[] = [
  { name: 'Koneksi Database', href: '/dbkoneksi', icon: LayoutDashboard }
]
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className={`fixed inset-y-0 left-0 z-50 w-64 flex-shrink-0 transform transition-transform lg:translate-x-0 ${
        ...
        <div className="flex flex-col h-screen">
          ...
          <div className="flex flex-col items-center justify-center px-6 py-6 space-y-3 flex-shrink-0" style={{ backgroundColor: '#003554', borderBottom: '8px solid white' }}>
          <Image src="/cacm_logo.png" alt="CACM Logo" width={80} height={40} className="object-contain" />
           
           
           {/*<div className="w-30 h-30 bg-white rounded-full flex items-center justify-center mb-3 p-2" style={{ boxShadow: '0px 0px 6px rgba(0,0,0,0.3)' }}>
            </div>*/}
      ...
      <header className="fixed top-0 left-0 right-0 lg:left-64 z-50 shadow-sm" style={{ background: 'linear-gradient(105.31deg, #0351B5 37.11%, #4AB6FF 93.5%)' }}>
          <div className="flex h-14 items-center gap-2 sm:gap-4 px-3 sm:px-4 lg:px-6">
            ...
            <div className="flex items-center gap-4">
              <Image src="/cacm_logo.png" alt="CACM Logo" width={40} height={30} className="hidden sm:block" />
