// File: app/(dashboard)/dokumentasi/[id]/desa/[desaId]/page.tsx
'use client'
...
export default function DokumentasiDesaDetailPage() {
  ...
  useEffect(() => {
    ;(async () => {
      setLoading(true)
      try {
        const res = await fetch(`/api/dokumentasi/${id}/desa/${desaId}`, { cache: 'no-store' })
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          <Link href={`/redflags/dokumentasi/${id}/desa`}>
