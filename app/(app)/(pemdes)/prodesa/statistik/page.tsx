  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Statistik Desa</h1>
          <p className="text-gray-600 mt-1">Statistik Desa</p>
        </div>
        <Link
          href="/dashboard"
      ...
      <div className="bg-white rounded-lg shadow p-6">
        <p className="text-gray-500 text-center py-8">
          Halaman Statistik Desa - Dalam Pengembangan
        </p>
      </div>
    </div>
  )
