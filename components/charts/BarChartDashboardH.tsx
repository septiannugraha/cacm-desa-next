...
>
  ...
  {mode === 'stacked' ? (
    <>
      ...
      <Bar dataKey="Nilai2" stackId="stack" name={nilai2Label} radius={[0, 20, 20, 0]}>
        {data.map((entry, index) => (
          <Cell
            key={`nilai2-${index}`}
    ...
    <>
      ...
      {/* Modal Table */}
      {showTable && (
        <div className="fixed top-0 left-64 right-0 bottom-0 z-50 bg-black bg-opacity-30 flex items-center justify-center">
